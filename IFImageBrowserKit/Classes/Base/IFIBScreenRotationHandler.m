...
@interface IFIBScreenRotationHandler ()
@property (nonatomic, assign) BOOL rotating;
@property (nonatomic, assign) UIDeviceOrientation currentOrientation;
@end

@implementation IFIBScreenRotationHandler {
...
- (void)orientationWillChangeWithExpectOrientation:(UIDeviceOrientation)orientation centerCell:(UICollectionViewCell<IFIBCellProtocol> *)centerCell {
    ...
    for (id<IFIBToolViewHandler> handler in _browser.toolViewHandlers) {
...
- (void)orientationChangeAnimationWithExpectOrientation:(UIDeviceOrientation)orientation centerCell:(UICollectionViewCell<IFIBCellProtocol> *)centerCell {
...
- (void)orientationDidChangedWithOrientation:(UIDeviceOrientation)orientation centerCell:(UICollectionViewCell<IFIBCellProtocol> *)centerCell {
...
- (void)deviceOrientationDidChangeNotification:(NSNotification *)note {
    ...
    UICollectionViewCell<IFIBCellProtocol> *centerCell = (UICollectionViewCell<IFIBCellProtocol> *)self->_browser.collectionView.centerCell;
