...
@interface IFBaseListCell ()
@property (weak, nonatomic) IBOutlet UIImageView *coverImgView;
@property (weak, nonatomic) IBOutlet UILabel *typeLabel;
@property (weak, nonatomic) IBOutlet UILabel *textLabel;
@end

@implementation IFBaseListCell
...
- (void)setData:(id)data {
    ...
    if ([data isKindOfClass:PHAsset.class]) {
        ...
        if (phAsset.mediaType == PHAssetMediaTypeVideo) {
            ...
            self.coverImgView.image = [IFIBIconManager sharedManager].videoBigPlayImage();
        } else {
        ...
        if ([imageStr hasPrefix:@"http"]) {
            [self.contentImgView sd_setImageWithURL:[NSURL URLWithString:imageStr] placeholderImage:nil];
