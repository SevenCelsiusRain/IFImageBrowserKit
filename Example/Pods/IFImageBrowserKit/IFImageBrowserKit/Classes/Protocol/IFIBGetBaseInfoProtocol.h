...
@protocol IFIBGetBaseInfoProtocol <NSObject>
...
/// 辅助视图处理器
@property (nonatomic, copy) id<IFIBAuxiliaryViewHandler>(^yb_auxiliaryViewHandler)(void);

/// 图片下载缓存相关中介者
@property (nonatomic, copy) id<IFIBWebImageMediator>(^yb_webImageMediator)(void);
